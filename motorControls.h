...
#define REV_UPPER_LEFT_MOTOR 8			//PORTB PIN 0
#define REV_BOTTOM_LEFT_MOTOR 9	  //PORTB PIN 1
#define REV_UPPER_RIGHT_MOTOR 10		//PORTB PIN 2
#define REV_BOTTOM_RIGHT_MOTOR 11  //PORTB PIN 3
